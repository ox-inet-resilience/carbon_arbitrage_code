...
def do_cf_battery_yearly():
    ...
    import coal_worker
    retraining_series = coal_worker.wage_lost_series * 7231 / coal_worker.wage_usd_dict["US"]
    # Set 2022 value to 0
    retraining_series = np.insert(retraining_series, 0, 0)
    coal_worker.opportunity_cost_series = np.insert(coal_worker.opportunity_cost_series, 0, 0)
    ...
    if os.path.isfile(fname):
        ...
        for label in labels:
            ...
            if "O" in label:
                ...
                yearly += coal_worker.opportunity_cost_series / 1e3
